...
def kor(x, y, hely):
    ...
    hely.create_rectangle(korr, korr, mezomeret + korr, mezomeret + korr, width=2, fill="dark grey",
                          outline="dark blue")
...
def uj():
    ...
    canNyert.create_rectangle(korr, korr, mezomeret + korr, mezomeret + korr, width=2, fill="dark grey",
                              outline="dark blue")
